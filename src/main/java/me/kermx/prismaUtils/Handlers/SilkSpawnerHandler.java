...
public class SilkSpawnerHandler implements Listener {
            ...
            if (!hasSilkTouch) {
                ...
                if (!isSneaking) {
                    ...
                    event.getPlayer().sendMessage(
                            MiniMessage.miniMessage().deserialize(ConfigUtils.getInstance().spawnerNoSilkWarningMessage));
                }
    ...
    private ItemStack createSpawnerItem(EntityType spawnedType) {
        ...
        if (spawnerItem.getItemMeta() instanceof BlockStateMeta blockStateMeta) {
            ...
            blockStateMeta.displayName(MiniMessage.miniMessage().deserialize(ConfigUtils.getInstance().spawnerName,
